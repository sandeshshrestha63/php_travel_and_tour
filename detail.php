...
$s="select * from tbl_package,tbl_category where tbl_package.cat_id=tbl_category.id and tbl_package.id='" . $_GET["pid"] ."'";
$result=mysqli_query($conn,$s);
$r=mysqli_num_rows($result);
//echo $r;
$n=0;
...
<td class="middletext" style="padding-left:15px"><img src="admin/uploads/<?php echo $data[5];?>" width="200px" height="200px"  /></td>
...
<tr><td colspan="3"><p><?php echo $data[4];?></p></td></tr>
